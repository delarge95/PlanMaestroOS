...
## Regla editorial y de derechos
No incrustar ni reconstruir páginas completas de los libros/PDF ni distribuir sus PDFs desde la app. Modelar únicamente los datos operativos necesarios para entrenar: nombre de ejercicio, series, repeticiones, descanso, esfuerzo, sustituciones permitidas y notas breves originales. Incluir atribución, fuente y enlace/ubicación de la fuente que el usuario ya posee.

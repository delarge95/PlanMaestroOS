  ...
  const renderPlayerContent = () => {
    ...
    if (isVimeo) {
      ...
      if (!isValidEmbedUrl(vimeoEmbedUrl)) {
        return <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '100%', color: '#ff453a' }}>URL de Vimeo no permitida por seguridad.</div>;
      }
    ...
    if (isYouTube) {
      ...
      if (!isValidEmbedUrl(embedUrl)) {
        return <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '100%', color: '#ff453a' }}>URL de YouTube no permitida por seguridad.</div>;
      }

  ...
  const renderPlayerContent = () => {
    ...
    if (isVimeo) {
      ...
      if (!isValidEmbedUrl(vimeoEmbedUrl)) {
        return <div style={{ padding: '16px', color: '#ff453a', textAlign: 'center' }}>URL de Vimeo no válida.</div>;
      }
    ...
    if (isYouTube) {
      ...
      if (!isValidEmbedUrl(embedUrl)) {
        return <div style={{ padding: '16px', color: '#ff453a', textAlign: 'center' }}>URL de YouTube no válida.</div>;
      }

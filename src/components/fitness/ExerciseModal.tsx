...
export default function ExerciseModal({
  ...
  const videoUrl2 =
    ...
    (targetExercise as any).videoUrl2;

  const mobilityList: string[] = (targetExercise as any).mobilityRequirements ||
    (targetExercise as any).mobility || [
    ...
    >
      <div
        style={{
          ...
          borderRadius: "24px",
          boxShadow:
            "0 30px 60px rgba(0, 0, 0, 0.6), 0 0 40px rgba(16, 185, 129, 0.08)",
          padding: "28px",
          display: "flex",
        ...
        <div style={{ flex: 1, minHeight: "160px" }}>
          ...
          {activeTab === "muscles" && (
            ...
            >
              ...
              {targetExercise.muscles.stability &&
                targetExercise.muscles.stability.length > 0 && (
                  <div>
                    <strong
                      style={{
                        fontSize: "0.78rem",
          ...
          {activeTab === "substitutions" && (
            ...
            >
              ...
              >
                Ordenadas por similitud muscular real — comparten los mismos
                músculos primarios y de estabilización.
              </p>
              ...
              {dynamicSubstitutions.length > 0 ? (
                ...
                >
                  No se encontraron sustituciones con similitud muscular
                  significativa.
                </p>
              )}

              {/* AUTHOR'S STATIC SUBSTITUTIONS — collapsible secondary section */}
              {targetExercise.substitutions &&
                targetExercise.substitutions.length > 0 && (
                  <div
                    style={{
                      marginTop: "8px",
                  ...
                  >
                    ...
                    >
                      {showStaticSubs ? "▲" : "▼"} Sugerencias del Autor (
                      {targetExercise.substitutions.length})
                    </button>

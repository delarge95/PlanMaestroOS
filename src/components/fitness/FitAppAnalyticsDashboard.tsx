...
export default function FitAppAnalyticsDashboard() {
  ...
  const SKILL_PROGRESSION = [
    { skill: 'Handstand Libre (Pared / Libre)', level: 'Intermedio A1', progress: 75, color: '#30d158' },
    { skill: 'Planche (Tuck Planche Leans)', level: 'Base Calistenia', progress: 60, color: '#0a84ff' },
    { skill: 'Dominadas Lastradas (Empuje/Tirón)', level: 'Fuerza Relativa', progress: 85, color: '#bf5af2' },
    { skill: 'Movilidad Cadera & Isquios (David Thurin)', level: 'Rehabilitación', progress: 70, color: '#ff9f0a' },
    { skill: 'Cardio LISS (30-45 min Bici/Caminata)', level: 'Regulación Estrés', progress: 90, color: '#64d2ff' }
  ];
    ...
    <ErrorBoundary>
      ...
      >
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '14px' }}>
          <div>
            <span style={{ fontSize: '0.72rem', fontFamily: 'SF Mono, monospace', color: '#30d158', fontWeight: 800, textTransform: 'uppercase' }}>
          ...
          <div style={{ display: 'flex', gap: '4px', background: 'rgba(255,255,255,0.06)', padding: '4px', borderRadius: '12px' }}>
            <button
              ...
              style={{ background: selectedRange === 'week' ? '#30d158' : 'transparent', color: selectedRange === 'week' ? '#000' : '#98989d', border: 'none', padding: '6px 12px', borderRadius: '8px', fontSize: '0.75rem', fontWeight: 700, cursor: 'pointer' }}
            >
              Semana
            </button>
            <button
              ...
              style={{ background: selectedRange === 'month' ? '#30d158' : 'transparent', color: selectedRange === 'month' ? '#000' : '#98989d', border: 'none', padding: '6px 12px', borderRadius: '8px', fontSize: '0.75rem', fontWeight: 700, cursor: 'pointer' }}
            >
              Mes
            </button>
          </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '16px' }}>
          <div style={{ background: 'rgba(0,0,0,0.3)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '16px', padding: '16px' }}>
            <span style={{ fontSize: '0.72rem', color: '#30d158', fontWeight: 700, textTransform: 'uppercase' }}>ADHERENCIA AM / PM</span>
            <strong style={{ fontSize: '1.8rem', display: 'block', margin: '4px 0', color: '#fff' }}>94%</strong>
            <span style={{ fontSize: '0.75rem', color: '#98989d' }}>15 de 16 bloques cumplidos</span>
          </div>

          <div style={{ background: 'rgba(0,0,0,0.3)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '16px', padding: '16px' }}>
            <span style={{ fontSize: '0.72rem', color: '#64d2ff', fontWeight: 700, textTransform: 'uppercase' }}>RATIO CARGA PLAN VS REAL</span>
            <strong style={{ fontSize: '1.8rem', display: 'block', margin: '4px 0', color: '#fff' }}>101%</strong>
            <span style={{ fontSize: '0.75rem', color: '#98989d' }}>4,850 kg ejec / 4,800 kg plan</span>
          </div>

          <div style={{ background: 'rgba(0,0,0,0.3)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '16px', padding: '16px' }}>
            <span style={{ fontSize: '0.72rem', color: '#ff9f0a', fontWeight: 700, textTransform: 'uppercase' }}>TENDENCIA DOLOR ARTICULAR</span>
            <strong style={{ fontSize: '1.8rem', display: 'block', margin: '4px 0', color: '#fff' }}>1.0 / 10</strong>
            <span style={{ fontSize: '0.75rem', color: '#30d158' }}>🟢 Zona Segura (Hombro & Rodilla OK)</span>
          </div>
        </div>
        ...
        <div style={{ background: 'rgba(0,0,0,0.4)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '18px', padding: '20px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
          <h4 style={{ fontSize: '1rem', margin: 0, color: '#ffffff', fontWeight: 700 }}>
            ...
            {VOLUME_DATA.map((d, idx) => {
              ...
              return (
                <div key={idx} style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', height: '100%', justifyContent: 'flex-end', gap: '8px' }}>
                  <span style={{ fontSize: '0.72rem', color: '#30d158', fontWeight: 700 }}>{d.executed} kg</span>
                  <div style={{ width: '36px', height: `${heightPct}%`, background: 'linear-gradient(180deg, #30d158, #059669)', borderRadius: '8px' }} />
                  <span style={{ fontSize: '0.75rem', color: '#98989d', fontFamily: 'SF Mono, monospace' }}>{d.label}</span>
                </div>
              );
            })}
          </div>

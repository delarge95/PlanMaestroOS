          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            <div style={{ background: '#000000', border: '1px solid rgba(255,255,255,0.12)', borderRadius: '18px', overflow: 'hidden', height: '500px', display: 'flex', flexDirection: 'column' }}>
              ...
              {isValidEmbedUrl(notionEmbedUrl) ? (
                ...
                <div style={{ padding: '20px', color: 'var(--color-accent-danger, #ff453a)', fontSize: '0.88rem', textAlign: 'center' }}>
                  ⚠️ URL de Notion no permitida o no válida. Asegúrate de que use HTTPS y sea un dominio autorizado.
                </div>
              )}
            </div>
          </div>
